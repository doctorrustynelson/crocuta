...
function DataUnit( key ){
	...
	this.balanced = function( ){
		if( Object.keys( this.locations < config.get( 'banzai.data.replication' ) ) )
			return false;
...
function DataDirector( ){
	...
	this.registerStore = function( location, keys ){
	...
	this.lostStore = function( location ){
